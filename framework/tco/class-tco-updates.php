	...
	class TCO_Updates {
		...
		public function remote_request() {
			...
			$args = wp_parse_args( $args, array(
				'api-key'  => '0ea5e6e857978344c7493cd6d7a5b8',
				'siteurl'  => 'btan.rocks',
			) );

	    if ( !$args['api-key'] )
	      $args['api-key'] = '0ea5e6e857978344c7493cd6d7a5b8';

	    $request_url = $this->base_url . trailingslashit( '0ea5e6e857978344c7493cd6d7a5b8' );
